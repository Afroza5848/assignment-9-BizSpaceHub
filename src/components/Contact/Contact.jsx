                ...
                <section className="py-6 bg-[#ff371719] dark:text-gray-900">
                    <div className="grid lg:max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                        <div className="py-6 mt-8  md:w-full w-10/12 mx-auto  md:py-0 md:px-6">
                            <p className="pt-2 pb-4 text-2xl font-medium roboto">A REAL ESTATE OWNERSHIP</p>
                            <h1 className="text-6xl font-bold oswald">CONTACT <span className="text-orange-600">INFO</span></h1>
                            <p className="pt-2 pb-8">For a Happy Living</p>
            ...
            <div className="container mx-auto">
                <div className="text-center mt-24 mb-16">
                    ...
                    <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-14">
                        <div className="border border-orange-300 p-10 bg-[#ff37173D] hover:bg-white ">
                        ...
                        <div className="border border-orange-300 p-10 bg-[#ff371719] hover:bg-white ">
