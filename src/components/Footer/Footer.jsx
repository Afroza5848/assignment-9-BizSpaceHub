...
const Footer = () => {
    return (
        <div className="bg-[#ff371719]">
            <footer className="container mx-auto footer p-10  text-base-content mt-10">
                <nav>
                ...
                <form>
                    ...
                    <fieldset className="form-control md:w-80 w-40">
            ...
            <div className="footer items-center p-4 bg-orange-600 text-white">
