            ...
            <div className="container px-2 flex flex-col justify-center lg:w-[60%] items-center mx-auto  lg:flex-row lg:justify-between">
                ...
                <div>
                    <div className="w-full max-w-lg p-10  space-y-3 rounded-xl dark:text-gray-800 bg-base-200">
                        <h1 className="text-3xl oswald font-bold text-center">Please Login</h1>
                        <form noValidate="" action="" className="space-y-6">
                            <div className="space-y-1 text-sm">
                                <label htmlFor="email" className="block dark:text-gray-600">Email</label>
                                <input type="email" name="email" id="email" placeholder="Write Your Email" className="w-full px-4 py-3 rounded-md border-gray-300 border dark:text-gray-800 focus:dark:border-orange-600" />
                            </div>
                            <div className="space-y-1 text-sm relative">
                                <label htmlFor="password" className="block dark:text-gray-600">Password</label>
                                <input type={showPassword ? "text" : "password"} name="password" id="password" placeholder="Password" className="w-full px-4 py-3 rounded-md border border-gray-300  dark:text-gray-800 focus:dark:border-orange-600" />
...
// lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128
// h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128